        ...
        <main className="project-picker">
            <div className="project-picker-heading">
                ...
                <div>
                    <h1>i18n Toolkit</h1>
                    <p>
                        Open a translation project or continue where you left
                        off.
                    </p>
                </div>
            </div>
            <div className="project-picker-cards">
                <section className="project-picker-card">
                    <div>
                        <h2>Open project</h2>
                        <p>
                            Select a Docusaurus project with <code>docs/</code>,
                            or a separated TOML project with{" "}
                ...
                <section
                    className="project-picker-card project-picker-recents"
                    aria-label="Recent projects"
                >
                    <div>
                        <h2>Recent projects</h2>
                        <p>Quickly reopen a project you worked on recently.</p>
                    </div>
                    {visibleRecentProjects.length ? (
                        <div className="project-picker-recent-list">
            ...
            {errorMessage ? (
                <p className="project-picker-error">{errorMessage}</p>
            ) : null}
        </main>
    );
}
